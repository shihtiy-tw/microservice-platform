...
1. **Create Vibe Kanban Tasks**:
   - For each **Phase/User Story** identified:
     ...
     - `title`: Use the Phase/Story header (e.g., "Phase 3: User Story 1 - [Title]").
     - `description`: Create a markdown checklist of all atomic tasks within that phase.
1. If there are tasks not belonging to any phase (e.g., at the top of the file), create a "General Setup" task for them.
